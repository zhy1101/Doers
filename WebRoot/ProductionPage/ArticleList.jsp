...
<title>热门文章</title>
	...
	<link rel="stylesheet" href="../../DoersInLocal/ProductionPage/css/dropDown.css">
	<link rel="stylesheet" href="../../DoersInLocal/ProductionPage/css/animate.css">
	<link rel="stylesheet" href="../../DoersInLocal/ProductionPage/css/icomoon.css">
	<link rel="stylesheet" href="../../DoersInLocal/ProductionPage/css/magnific-popup.css">
	<link rel="stylesheet" href="../../DoersInLocal/ProductionPage/css/salvattore.css">
	<link rel="stylesheet" href="../../DoersInLocal/ProductionPage/css/style.css">
	<script src="../../DoersInLocal/ProductionPage/js/modernizr-2.6.2.min.js"></script>	
</head>
<body>
<header>
	...
	<div id="fh5co-main">
		<div class="container">
			<div class="row">
        		...
        		<s:iterator value="#hotArticleList" var="hotart">
        			<div class="item">
		        	<div class="animate-box">
			        		<a href="<s:property value="#hotart.coverURL" />" class="image-popup fh5co-board-img" title="<s:property value="#hotart.articleTitle" />"><img src="<s:property value="#hotart.coverURL" />" ></a>
		        		</div>
		        		<div class="fh5co-desc"><a href="${pageContext.request.contextPath}/productionDetailAction_showArticleDetail?articleId=<s:property value="#hotart.articleId" />"><s:property value="#hotart.articleTitle" /></a></div>
		        	</div>
        		</s:iterator>
       			</div>
        	</div>
	...
	<script src="../../DoersInLocal/ProductionPage/js/jquery.min.js"></script>
	<script src="../../DoersInLocal/js/jquery.easing.min.js"></script>
	<script src="../../DoersInLocal/bootstrap/js/bootstrap.min.js"></script>
	<script src="../../DoersInLocal/ProductionPage/js/jquery.waypoints.min.js"></script>
	<script src="../../DoersInLocal/ProductionPage/js/jquery.magnific-popup.min.js"></script>
	<script src="../../DoersInLocal/ProductionPage/js/salvattore.min.js"></script>
	<script src="../../DoersInLocal/ProductionPage/js/main.js"></script>
	<script type="text/javascript" src="../../DoersInLocal/ProductionPage/js/jquery.dropdown.js"></script>
