        ...
        DateInput.prototype = {
            ...
            selectMonth: function(date) {
                ...
                if (!this.currentMonth || !(this.currentMonth.getFullYear() == newMonth.getFullYear() && this.currentMonth.getMonth() == newMonth.getMonth())) {
                    ...
                    for (var i = 0; i <= numDays; i++) {
                        var currentDay = new Date(rangeStart.getFullYear(),rangeStart.getMonth(),rangeStart.getDate() + i,12);
            ...
            stringToDate: function(string) {
                ...
                if (matches = string.match(/^(\d{1,2}) ([^\s]+) (\d{4,4})$/)) {
                    return new Date(matches[3],this.shortMonthNum(matches[2]),matches[1],12)
                } else {
                    return null
                }
            },
