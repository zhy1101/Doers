	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/serverConnectProductionAction_refreshConnectionStepTwo" method="post" style="margin-top: 5px;">
				</c:if >
